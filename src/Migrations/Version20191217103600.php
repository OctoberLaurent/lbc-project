 ...
 */
final class Version20191217103600 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE ads (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', created_by_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', category_id INT DEFAULT NULL, location_id INT DEFAULT NULL, title VARCHAR(90) NOT NULL, slug VARCHAR(90) NOT NULL, price NUMERIC(10, 2) NOT NULL, description LONGTEXT NOT NULL, langage VARCHAR(2) NOT NULL, state enum(\'new\',\'used\',\'broken\'), date_publish DATETIME NOT NULL, date_expire DATETIME NOT NULL, INDEX IDX_7EC9F620B03A8386 (created_by_id), INDEX IDX_7EC9F62012469DE2 (category_id), INDEX IDX_7EC9F62064D218E (location_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE attachements (id INT AUTO_INCREMENT NOT NULL, media_id INT DEFAULT NULL, ad_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', title VARCHAR(80) NOT NULL, INDEX IDX_212B82DCEA9FDD75 (media_id), INDEX IDX_212B82DC4F34D596 (ad_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE media (id INT AUTO_INCREMENT NOT NULL, user_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', type enum(\'image\',\'video\',\'sound\'), path VARCHAR(40) NOT NULL, INDEX IDX_6A2CA10CA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE offers (id INT AUTO_INCREMENT NOT NULL, user_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', ad_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', price NUMERIC(10, 2) NOT NULL, message LONGTEXT NOT NULL, offer_date DATETIME NOT NULL, INDEX IDX_DA460427A76ED395 (user_id), INDEX IDX_DA4604274F34D596 (ad_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE users (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', picture_id INT DEFAULT NULL, adress_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, firstname VARCHAR(40) NOT NULL, lastname VARCHAR(40) NOT NULL, screenname VARCHAR(50) NOT NULL, phone VARCHAR(20) DEFAULT NULL, birthday DATETIME NOT NULL, langage CHAR(2) NOT NULL, is_active TINYINT(1) NOT NULL, activation_token VARCHAR(255) DEFAULT NULL, passwordtoken VARCHAR(255) DEFAULT NULL, password_token_expiration DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_1483A5E9E7927C74 (email), INDEX IDX_1483A5E9EE45BDBF (picture_id), INDEX IDX_1483A5E98486F9AC (adress_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE attachements DROP FOREIGN KEY FK_212B82DC4F34D596');
